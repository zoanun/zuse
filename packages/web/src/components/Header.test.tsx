...
describe('Header', () => {
  it('shows ctx used / window / percent', () => {
    render(<Header state={{ ...initialState, connection: 'live', model: 'claude', contextTokens: 4700, contextWindow: 200000 }} onMenu={() => {}} onOpenManage={() => {}} onChangeCwd={() => {}} onSwitchModel={() => {}} onCyclePermissionMode={() => {}} />)
  ...
  it('⚙ button fires onOpenManage', () => {
    ...
    render(<Header state={initialState} onMenu={() => {}} onOpenManage={onOpenManage} onChangeCwd={() => {}} onSwitchModel={() => {}} onCyclePermissionMode={() => {}} />)
  ...
  it('clicking the model chip opens the ModelPicker', async () => {
    ...
    render(<Header state={{ ...initialState, model: 'kimi-k2.6' }} onMenu={() => {}} onOpenManage={() => {}} onChangeCwd={() => {}} onSwitchModel={() => {}} onCyclePermissionMode={() => {}} />)
